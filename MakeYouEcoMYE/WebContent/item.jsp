...
<body>
	...
	<div class="container">
		...
		<div class="paragraphs-container">
			...
			<a class="btn btn-dark"	href="add-to-cart?id=<%=product.getId()%>"><i class="fa fa-shopping-cart"></i></a>
			<a class="btn btn-primary" href="add-to-cart?id=<%=product.getId()%>&order-now=yes"><i class="fas fa-home mr-3"></i></a>
		</div>
	</div>
	<br><br><br>
