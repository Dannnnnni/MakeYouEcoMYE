...
public class UserDao {
	...
	public boolean insertUser(String name, String surname, String email, String password, String date_registration, String telephone) {
		...
		try {
			...
			pst.setString(5, date_registration);
